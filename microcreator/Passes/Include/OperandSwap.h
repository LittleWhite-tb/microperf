...
/**
  @file OperandSwap.h
  @brief The OperandSwap pass header is in this file 
 */

#ifndef H_OPERANDSWAP
#define H_OPERANDSWAP
...
/**
 * @class OperandSwap
 * @brief The OperandSwap defines what to do for one pass
 */
class OperandSwap:public Pass
{
	protected:
		...
		/**
		 * @brief Handle the swap of a kernel
		 ...
		 */
		void handleSwap (std::vector <Kernel*> &kernels, const Kernel *kernel, Kernel *outer, unsigned int start = 0) const;
